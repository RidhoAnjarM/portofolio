<template>
    <Header />
    <section class="mb-[52px] lg:mb-[121px] w-full h-[768px]">
        <div class="container">
            <div class="flex flex-wrap lg:flex w-full lg:justify-between lg:flex-nowrap">
                <div class="w-full flex mt-[152px] lg:mt-[221px] lg:justify-between">
                    <div
                        ...
                        <div class="">
                            <h1
                                class="text-[16px] text-white font-space-grotesk font-normal ms-[58px] mt-[22px] lg:text-[32px] lg:m-[80px_0px_26px_108px]">
                                Hello
                                everyone, i'am</h1>
                            <div
                                class="w-[250px] h-[33px] bg-primary rounded-full flex items-center justify-center mx-auto my-[10px] lg:w-[447px] lg:h-[47px] lg:ms-[82px]">
                                <h1 class="text-[16px] text-dark font-space-grotesk font-normal lg:text-[32px]">Ridho
                                    Anjar Maulana
                                </h1>
                            </div>
                            <h1
                                class="text-[16px] text-white font-space-grotesk font-normal ms-[58px] lg:text-[32px] lg:ms-[108px] mt-[26px]">
                                Web Develover
                            </h1>
                            <p
                                class="w-[269px] text-[14px] text-white font-space-grotesk font-light mt-[26px] mx-auto lg:w-[487px] lg:ms-[95px] lg:text-[15px]">
                                "As
                                ...
                                bring
                                ideas to life through responsive design and optimal functionality."</p>
                        </div>
                ...
                <div class="flex flex-wrap">
                    <div
                        class="w-[295px] h-[333px] rounded-[30px] bg-primary overflow-hidden flex items-end mt-[50px] lg:mt-[144px] lg:w-[349px] lg:h-[395px] mx-auto lg:mx-0 ">
                    ...
                    <div
                        ...
                        <div
                            class="w-[230px] h-[50px] rounded-full bg-secondary flex items-center justify-center mt-[18px] ms-[20px] lg:w-[349px] lg:h-[65px] lg:rounded-[20px] lg:border-2 lg:border-secondary hover:lg:text-secondary hover:lg:bg-primary hover:lg:shadow-2xl duration-500 ease-in-out lg:ms-0 border-2 border-primary">
                            <a href="project"
                                ...
                                <span class="me-[10px]"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="22.5"
                                    ...
                                    </svg></span><span>View Project</span></a>
                        </div>
                    </div>
                </div>
            </div>
